...
if(__name__ == "__main__"):
    ...
    for i in range(p_len,p_len-10,-1):
        r_lianxu_n = guilv1.get_redballs_comply_stat_min_max(lianxu_n=i)
        print(r_lianxu_n)
    ## 验证  
    ...
    #    r_lianxu_n = guilv1.get_redballs_comply_stat_min_max(lianxu_n=p_len)
    #    print(r_lianxu_n)
